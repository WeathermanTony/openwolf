...
function maybeNudgeAutonomyContinuation(wolfDir, session, sessionFile, transcriptPath) {
    ...
    // like (a+)+, (a*)*, alternation-with-quantifier like (a|aa)+, and cap text length
    // to limit worst-case backtracking. Scan prefix + suffix so asks at the end aren't missed.
