...
const MAX_PROBE = 100;
export function deterministicBasePort(projectRoot) {
...
export async function allocateProjectPorts(projectRoot) {
    ...
    throw new Error(`Could not find free port pair near ${base} after ${MAX_PROBE} probes`);
}
